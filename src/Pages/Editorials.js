...
function Editorials({currentItem, setCurrentItem, setCartItems, cartItems, setTotal, total}) {
    ...
    <div className='pt-20 px-5 sm:px-16 text-zinc-500'>
      <div className='mb-12'>Home/Marketplace/Editorials/<span className='text-black'>{currentItem.itemName}</span></div>
        {currentItem.itemName && <div className='flex flex-col sm:flex-row border-2 sm:h-96'>
          <div className='w-full sm:w-5/12 p-3'><img className='w-full h-full' src={currentItem.imgSrc} alt='img'/></div>
            ...
            <div className='mt-2 h-80 flex flex-col justify-between'>
              <div className='text-sm mt-2 pl-4'>
                ...
                <div className='flex mt-4'>
                  <button onClick={addToCart} className='bg-blue-700 py-1 w-36 text-white mr-3'>Add to cart</button>
